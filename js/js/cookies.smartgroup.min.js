...
(function(e){e.smartGroupCookies={display:function(t){var n='<div id="sgCookiesPolicyBar"><div id="sgCookiesPolicyInformation"></div></div>',r='Serwis wykorzystuje pliki cookies niezbedne do prawidlowego dzialania.<br />Zasady stosowania plików cookies w <a href="'+t.url+'">Polityce cookies</a>',i="<p>"+(t.closeImg!==undefined?'<img src="'+t.closeImg+'" alt="zamknij" title="zamknij" />':"[zamknij]")+"</p>";if(e.cookie("smartGroupCookies")!="off"){e("body").append(n);e("#sgCookiesPolicyInformation").html(i+r);e("#sgCookiesPolicyInformation p").bind("click",function(t){e.smartGroupCookies.close(t)})}},close:function(t){e("#sgCookiesPolicyBar").fadeOut("500");e.cookie("smartGroupCookies","off",{expires:30,path:"/"})}}})(jQuery)